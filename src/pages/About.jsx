...
return(
    <>
        <div className="my-[50vh] mx-[30vh] flex space-x-36">
            <img className="w-[500px] rounded-sm" src={me} alt="imageofme" />
            <aside className="space-y-5">
                <h1 className="text-5xl text-red-500">Who am I?</h1>
                <p className="text-2xl text-slate-700 leading-loose">A curious and self-motivated frontend developer 
